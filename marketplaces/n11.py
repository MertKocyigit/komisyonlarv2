...
class N11Marketplace(BaseMarketplace):
    code = "n11"

    def __init__(self, csv_path: str):
        # N11 ETL çıktın: Kategori / Alt Kategori / Ürün Grubu / Komisyon_%_KDV_Dahil
        mapping = {
            "category": "Kategori",
    ...
    def find_commission(self, path: CategoryPath) -> Optional[Commission]:
        ...
        try:
            ...
            return None
        return Commission(rate_percent=rate, source="n11", note=None)
